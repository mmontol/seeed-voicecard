...
HATS="/dtb/overlay/seeed-4mic-voicecard-lubancat.dtbo"
...
rm  ${OVERLAYS}/seeed-4mic-voicecard-lubancat.dtbo || true
# rm  ${OVERLAYS}/seeed-8mic-voicecard.dtbo || true

echo "remove alsa configs"
rm -rf  /etc/voicecard/ || true

echo "disabled seeed-voicecard-lubancat.service "
systemctl stop seeed-voicecard-lubancat.service
systemctl disable seeed-voicecard-lubancat.service 
